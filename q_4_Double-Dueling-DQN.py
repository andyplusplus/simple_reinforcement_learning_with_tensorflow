...
# The agent learn to solve a navigation task in a basic grid world. To learn more, 
# read here: https://medium.com/p/8438a3e2b8df
# 
...
# In[2]: # Feel free to adjust the size of the gridworld. Making it smaller provides an easier task for our DQN agent,
...
annealing_steps = 10000. #How many steps of training to reduce startE_1 to endE_01.
