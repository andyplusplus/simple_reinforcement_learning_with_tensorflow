...
* [github](https://gist.github.com/awjuliani/1256e7ad7c8ac54051d09963606c8a47#file-rl-tutorial-3-ipynb)
...
# Here we implement a multi-layer neural network that predicts
# the next observation, reward, and done state from a current
# state and action.
